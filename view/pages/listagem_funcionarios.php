    ...
    <div class="section fade-bg">
      ...
      <div class="intro-content">
        ...
        <table class="listaBorda">
          ...
          <?php require_once '../../model/listar_funcionarios.php'; ?>
          <?php require_once '../../model/excluir_funcionario.php'; ?>
          <?php foreach ($funcionarios as $key => $value) { ?>
            ...
            <tr>
              ...
              <td>R$<?php echo $value['salario']; ?></td>
              <td><?php echo $value['data_admissao']; ?></td>
              <td>
